            ...
            <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
              <Fade bottom>
                <p className="font-bold">
                  Welcome to SANKOH TECHNICAL SOLUTIONS, established in 2018, is
                  a leading manufacturer of high-quality manual valves and a
                  trusted supplier of manual and automated valves and process
              ...
              <Fade bottom delay={600}>
                <p className="font-bold">
                  At Sankoh Technical Solutions, we understand that reliable
                  valve solutions are crucial for the smooth operation of your
                  facilities. That's why we maintain high standards in product
                  quality, technical expertise, and customer service. Our
                  commitment to excellence has helped us build a strong
                  reputation and a growing base of satisfied clients across
                  various industries.
                </p>
              </Fade>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 max-w-6xl mx-auto">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <p className="text-gray-600 leading-relaxed">
                    ...
                    standards and customer expectations. We strive to be the
                    most trusted partner in industrial solutions through:
                  </p>
            ...
            <Fade bottom delay={400}>
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <p className="text-gray-600 leading-relaxed">
                    To be India's leading provider of industrial valve
                    solutions, recognized for our:
                  </p>
                  <ul className="space-y-3">
                    {[
                  ...
                  <p className="text-gray-600 mt-4">
                    We aspire to set new industry benchmarks and contribute to
                    our clients' success by providing reliable, innovative, and
